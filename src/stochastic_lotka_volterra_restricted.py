""" Contains modules for executing Monte Carlo simulation of the stochastic
    ...
    of two-dimensional fractional Brownian motion. Throughout the time evolution
    of the lattice, prey is restricted to inhabit only those sites they inhabited
    initially, i.e. sites eligible for prey are static and generated using fBm.
    Predators are initially distributed uniformly on empty sites, i.e. those not
    eligible to be occupied by prey.
